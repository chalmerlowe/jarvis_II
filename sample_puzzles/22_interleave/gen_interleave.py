# TITLE: interleave >> gen_interleave.py
# AUTHOR: Chalmer Lowe
# DESCRIPTION:

# This code generates the input file for the interleave puzzle.
...
with open('interleave.txt', 'w') as fout:
    for line in range(2):
        nums = [str(randint(1, 43)) for num in range(100)]
        nums = ';'.join(nums) + '\n'
        fout.write(nums)
